...
- **Role catalog schema compliance**: All 11 agentic roles updated with `domains` property
  - Required by updated role-prompt.schema.json from 3leaps/crucible v0.1.8
...
- **3leaps/crucible v0.1.8 upstream sync**: Latest galaxy-level standards
  ...
  - Updated PROVENANCE.md to track v0.1.8 (commit 01e9048)
...
- **Upstream provenance**: Bumped from v0.1.6 to v0.1.8
