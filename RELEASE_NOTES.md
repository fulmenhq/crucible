...
**Updated all 11 agentic roles with `domains` property for business-process organization, synced latest 3leaps/crucible v0.1.10 with formatted schemas and governance role enhancements.**
...
- **Upstream v0.1.10 Sync**: 28 files from 3leaps/crucible
