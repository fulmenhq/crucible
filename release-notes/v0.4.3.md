...
fmt.Println(brand.Short)    // One-liner
fmt.Println(brand.Extended) // Two-line summary
fmt.Println(brand.Full)     // Full paragraph
```
...
```
$ rampart version --extended
rampart v1.0.0
  Variant:   001 (http-scenarios)
  Commit:    abc1234
  Crucible:  0.4.3

Fulmen - Open-source enterprise application infrastructure by 3leaps
https://fulmenhq.dev
```
