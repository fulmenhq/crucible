...
async function main(): Promise<void> {
  ...
  const simplifiedModesPath = path.resolve(repoRoot, 'config/library/foundry/simplified-modes.snapshot.json');
  await writeFile(simplifiedModesPath, JSON.stringify(simplifiedModesSnapshot, null, 2) + '\n', 'utf8');
